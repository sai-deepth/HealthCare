...
select dia1.ChainOrganization as ChainOrganization,  count(dia2.TotalPerformanceScore) as TotalPerformanceScore 
from d.dia1 join d.dia2 on dia1.FacilityName = `dia2`.`Facility Name` 
